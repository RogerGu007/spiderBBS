...
public class ECUSTSiteConstant {

    public static final String LOGIN_URL = "http://bbs.myecust.com/member.php?mod=logging&action=login&" +
            "loginsubmit=yes&loginhash=LvSg0&inajax=1";
    public static final String JOB_URL  = "http://bbs.myecust.com/thread-htm-fid-61.html";

//    public static final String FRIEND_URL = "https://bbs.tongji.net/forum-336-1.html";

    public static final String ECUST_BBS_DOMAIN = "bbs.myecust.com";
