...
//    public static final String FRIEND_URL = "https://bbs.tongji.net/forum-336-1.html";
    ...
    //列表页是脚本形式的
    public static final String FORMNODE = "//table[6]/tbody/script";
    public static final String FORM_ITEM_REGEX = "origin = new Post(.*)";
    public static final String FORM_ITEM_LINK_TEMPLATE =
            "http://bbs.whu.edu.cn/wForum/disparticle.php?boardName=Job&ID=PLACEHOLDER_ID&pos=18";
