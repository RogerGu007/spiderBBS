...
//    public static final String FRIEND_URL = "https://bbs.tongji.net/forum-336-1.html";
    ...
    public static final String FORMITEMLINK = "//a/@href";
    //三种格式：1、04-03 14:49   2、16:59   3.昨天 13:08   都要补全为 2018-04-06 21:00:00
    public static final String FORMITEMMODIFYTIME= "//div[5]/div[2]";
    //有页码，也有下一页，替换掉首页的字符串?bid=845&mode=topic即可  for example: ?bid=845&mode=topic&page=2
    public static final String FORMITEMNEXTPAGE = "//*[@id=\"board-body\"]/div[3]/div/a/@href";
    //主题
    ...
    //一行一个p标签，需要过滤掉为空的行
    public static final String DETAIL = "//*[@id=\"post-read\"]/div[2]/div/div[3]/div[1]/div[1]/p";
    //详情页标题
